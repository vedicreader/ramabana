...
# %% auto #0
__all__ = ['MAX_DETAIL', 'MAX_ACTS', 'MAX_CHECKPOINTS', 'POLL_EVERY', 'ICONS', 'DENIED', 'DFLT_TIMEOUT', 'MAX_PREVIEW',
           'INLINE_SKILLS', 'MAX_CONTEXT_FILE', 'CONTEXT_FILES', 'RULES', 'COMPLETE_SP', 'MAX_COMPLETION_LINES',
           ...
           'request_text', 'prompt_directives', 'project_context', 'work_rules', 'system_prompt', 'Agent', 'Completer']
