...
# %% auto #0
__all__ = ['MAX_DETAIL', 'MAX_ACTS', 'RESUME_DETAIL', 'MAX_CHECKPOINTS', 'POLL_EVERY', 'SHELL_SNAPSHOT', 'ICONS', 'DENIED',
           'DFLT_TIMEOUT', 'MAX_PREVIEW', 'INLINE_SKILLS', 'MAX_CONTEXT_FILE', 'CONTEXT_FILES', 'RULES',
           'OUTPUT_CONTRACT', 'CLAUDE_NOTES', 'TODO_STATUSES', 'TODO_MARK', 'COMPLETE_SP', 'MAX_COMPLETION_LINES',
           'COMPLETION_TOKENS', 'CTX_BEFORE', 'CTX_AFTER', 'summarise', 'Act', 'Activity', 'preview_for', 'Ask',
           'ask_md', 'answer_md', 'Approvals', 'always', 'never', 'policy', 'applied', 'apply', 'note', 'tool_plan',
