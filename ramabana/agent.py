...
# %% auto #0
__all__ = ['MAX_DETAIL', 'MAX_ACTS', 'ICONS', 'DENIED', 'DFLT_TIMEOUT', 'MAX_PREVIEW', 'INLINE_SKILLS', 'MAX_CONTEXT_FILE',
           'CONTEXT_FILES', 'RULES', 'COMPLETE_SP', 'MAX_COMPLETION_LINES', 'COMPLETION_TOKENS', 'CTX_BEFORE',
           'CTX_AFTER', 'summarise', 'Act', 'Activity', 'preview_for', 'Ask', 'ask_md', 'answer_md', 'Approvals',
           'always', 'never', 'policy', 'applied', 'apply', 'note', 'tool_plan', 'request_text', 'prompt_directives',
           'project_context', 'work_rules', 'system_prompt', 'Agent', 'Completer']
...
RULES = (
    ...
    (None, 'Paths must be inside the folders above. Anything else is refused.'),
