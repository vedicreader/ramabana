...
# %% auto #0
__all__ = ['SANDBOX', 'SECRET', 'DENY', 'SKIP_DIRS', 'SKIP_SUFFIXES', 'MAX_FILE', 'MAX_VARS', 'LD_CHARS', 'GROUP',
           'EXTRA_MODULES', 'MAX_SKILL_CHARS', 'SKILL_DESC_MAX', 'EVENTS', 'MAX_TOOL_CHARS', 'MAX_HITS',
           'MAX_GREP_HITS', 'WRITE_TOOLS', 'ERR', 'SUB_MAX_STEPS', 'SUB_SP', 'NO_SUB', 'Hit', 'Host', 'NullHost',
           'denied', 'ld_json', 'LocalHost', 'Skill', 'skill_dirs', 'discover', 'skill_index', 'find', 'Registry',
           'ext_dirs', 'load', 'err', 'failed', 'clip', 'clip_lines', 'readable', 'code_tools', 'file_tools',
           'notebook_tools', 'web_tools', 'memory_tools', 'watch_tools', 'session_tools', 'shell_tools', 'skill_tools',
