...
# %% auto #0
__all__ = ['DARK', 'LIGHT', 'THEMES', 'PALE_THEMES', 'CODE_THEMES', 'KAKU', 'GRUVBOX', 'ACTIVE_THEME', 'MARKDOWN_THEME',
           'GUTTERS', 'FOLD', 'FOLD_TOOL', 'NOTIFY_EVERY', 'FOLD_RUNNING', 'ACT_EVERY', 'FOLD_STEP', 'STREAM_EVERY',
           'ACT_TAIL', 'MAX_GROUP_ROWS', 'MOUSE_ON', 'MOUSE_OFF', 'SURFACE_COMMANDS', 'HELP', 'BOW', 'WORDMARK',
           'BANNER_GAP', 'BANNER_MIN', 'ARROW', 'MARK_WIDTH', 'SLACK', 'FLIGHT', 'FLIGHT_WIDTH', 'BUILD', 'VERSION',
           'GUIDE', 'MEDIA', 'MAX_MEDIA', 'MAX_ATTACH', 'CLIP_IMAGE', 'ATTACH_REF', 'TRAILING', 'KITTY_ENV',
           'KITTY_TERM', 'KITTY_PROGRAM', 'MAX_IMG_COLS', 'CELL_ASPECT', 'MAX_IMG_DRAW', 'APC_CHUNK', 'MAX_FILE_ATTACH',
           'REFACTOR', 'MENUS', 'PYREPL_MODULES', 'code_theme', 'set_theme', 'plan_text', 'banner', 'arrow_mark',
           'flight_line', 'key_card', 'guide_text', 'media_path', 'is_media', 'media_paths', 'attach_refs',
           'clipboard_png', 'Attachment', 'sendable', 'media_parts', 'media_note', 'kitty_graphics', 'png_size',
           'img_cells', 'draw_png', 'media_line', 'file_refs', 'FileAttachment', 'file_note', 'Option', 'options_for',
