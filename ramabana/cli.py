...
# %% auto #0
__all__ = ['INK_PATCHED', 'DARK', 'LIGHT', 'GITHUB_DARK', 'THEMES', 'CODE_THEMES', 'KAKU', 'GRUVBOX', 'ACTIVE_THEME',
           'MARKDOWN_THEME', 'GUTTERS', 'FOLD', 'FOLD_TOOL', 'NOTIFY_EVERY', 'FOLD_RUNNING', 'ACT_EVERY', 'FOLD_STEP',
           'STREAM_EVERY', 'ACT_TAIL', 'MAX_GROUP_ROWS', 'MOUSE_ON', 'MOUSE_OFF', 'SURFACE_COMMANDS', 'HELP', 'BUILD',
           'VERSION', 'GUIDE', 'MEDIA', 'MAX_MEDIA', 'MAX_ATTACH', 'CLIP_IMAGE', 'ATTACH_REF', 'TRAILING', 'KITTY_ENV',
           'KITTY_TERM', 'KITTY_PROGRAM', 'MAX_IMG_COLS', 'CELL_ASPECT', 'MAX_IMG_DRAW', 'APC_CHUNK', 'MAX_FILE_ATTACH',
           'REFACTOR', 'MENUS', 'BLOCK_START', 'PYREPL_MODULES', 'code_theme', 'code_bg', 'set_theme', 'plan_text',
