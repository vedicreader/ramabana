...
# %% auto #0
__all__ = ['ENV_PREFIX', 'ENV_FALLBACK', 'JOBS', 'LOCAL', 'MLX', 'LLAMA', 'GPT', 'CLAUDE', 'CLOUD', 'CUSTOM', 'MODELS',
           'DFLT_LOCAL', 'completer', 'cheap', 'DEFAULT_POLICY', 'DFLT_LOCAL_CTX', 'AgentError', 'agent_err',
...
def resolve(name, default_local=DFLT_LOCAL):
    ...
    if name in MODELS:
        ...
        if backend != 'remote': return ModelSpec(name, backend, mid, local_ctx(name), config=config)
